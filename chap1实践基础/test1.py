...
reconstruction_error = np.linspace(0.0, 0.06, 20)

# Replace these lists with the estimated data extracted from the plot
ours_estimated = [24, 23.5,23, 12, 6, 3, 2, 1, 0.5, 0.3, 0.2, 0.1, 0.05]
apss_estimated = [5, 5.4, 5.6, 5, 4, 3, 2, 1.5, 1, 0.7, 0.5, 0.3]
